...
const CaseStudies: FC = () => {
  return (
    <>
      ...
      <section
        className={`relative py-10 bg-linear-to-br from-teal-50 to-blue-50 text-gray-900`}
      >
      ...
      <section
        className={`py-10 bg-linear-to-br from-teal-50 to-blue-50 text-gray-900`}
      >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2">
                  ...
                  <div className="relative overflow-hidden">
                    ...
                    <img
                      src={study.image}
                      alt={study.title}
                      className="w-full h-64 lg:h-[70vh] object-cover"
                    />
